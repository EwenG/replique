...
;; As a multi-byte encoding system, UTF-8 is only suitable to encode text, not binary data
;; On the contrary, ISO-8859-1 can be used to encode binary data
(def text-encoding #{"text/plain" "text/html" "text/css" "text/javascript"
                     "text/x-clojure" "application/json" "text/csv" "application/dart"
                     "application/edn" "text/x-setext" "text/sgml" "text/xml"})
