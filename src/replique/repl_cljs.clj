...
(let [{cljs-major :major
  ...
  (assert (or (> cljs-major 1) (> cljs-minor 10)
              (and (= cljs-major 1) (= cljs-minor 10)
                   (>= cljs-qualifier 238)))
          (format "Replique is compatible with clojurescript 1.10.238+, current version is: %s.%s.%s" cljs-major cljs-minor cljs-qualifier)))
